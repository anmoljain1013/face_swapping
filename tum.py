...
def extract_index_nparray(nparray):
    ...
    for num in nparray[0]:
        ...
        break
    return index
img = cv2.imread("images/cris.jpg",1)
img2 = cv2.imread("images/bobmarley.jpg",1)
...
#    first face
    ...
    seamlessclone = cv2.seamlessClone(result ,img2, img2_head_mask, seamless, cv2.NORMAL_CLONE)
